...
function NewEditMemberProfileFields({ cardContent, profileSettings, setProfileSettings }: Props): JSX.Element {
  ...
  return (
    <CardContainerEditEnabled backgroundColor={COLOR} testID="edit-member-profile-fields">
...
export default NewEditMemberProfileFields;
